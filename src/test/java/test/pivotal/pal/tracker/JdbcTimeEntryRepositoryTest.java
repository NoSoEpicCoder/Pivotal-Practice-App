...
import com.accenture.JdbcTimeEntryRepository;
...
public class JdbcTimeEntryRepositoryTest {
    ...
    @Test
    public void createTimeEntryRecord() {
    ...
    @Test
    public void createReturnsCreatedTimeEntry() {
        TimeEntry newTimeEntry = new TimeEntry(123, 321, LocalDate.parse("2017-01-09"), 8);
        TimeEntry entry = subject.create(newTimeEntry);
    ...
    @Test
    public void findTimeEntry() {
        jdbcTemplate.execute("INSERT INTO time_entries (id, project_id, user_id, date, hours) VALUES (999, 123, 321, '2017-01-09', 8)");
    ...
    @Test
    public void listTimeEntries() {
        jdbcTemplate.execute("INSERT INTO time_entries (id, project_id, user_id, date, hours) VALUES (999, 123, 321, '2017-01-09', 8), (888, 456, 678, '2017-01-08', 9)");
    ...
    public void updatedRecord() {
        jdbcTemplate.execute("INSERT INTO time_entries (id, project_id, user_id, date, hours) VALUES (1000, 123, 321, '2017-01-09', 8)");
